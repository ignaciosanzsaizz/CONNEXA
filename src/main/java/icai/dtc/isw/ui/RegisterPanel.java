...
public class RegisterPanel extends JPanel {
    ...
    /**
     * @param onRegister callback con "email|username|password"
     * @param onBack     callback al pulsar "Volver"
     */
    public RegisterPanel(Consumer<String[]> onRegister, Runnable onBack) {
        ...
        lblUser.setForeground(new Color(20, 40, 80));
        gbc.gridy = 4; gbc.insets = new Insets(2, 8, 2, 8);
        card.add(lblUser, gbc);

        txtUser = UIUtils.styledTextField(24);
        gbc.gridy = 5; gbc.insets = new Insets(2, 8, 8, 8);
        card.add(txtUser, gbc);

        // Contraseña
        JLabel lblPass = new JLabel("Contraseña");
        lblPass.setForeground(new Color(20, 40, 80));
        gbc.gridy = 6; gbc.insets = new Insets(2, 8, 2, 8);
        card.add(lblPass, gbc);

        txtPass = UIUtils.styledPassField(24);
        gbc.gridy = 7; gbc.insets = new Insets(2, 8, 2, 8);
        ...
        gbc.gridy = 8; gbc.insets = new Insets(0,8,8,8);
        card.add(chk, gbc);

        lblError = new JLabel(" ");
        lblError.setForeground(new Color(200, 30, 30));
        gbc.gridy = 9; gbc.insets = new Insets(4, 8, 8, 8);
        ...
        btnRegistrar.setBackground(darkBlue);
        btnRegistrar.setForeground(Color.WHITE);
        btnRegistrar.setBorder(new UIUtils.RoundedBorder(14, darkBlue));
        ...
        gbc.gridy = 10; gbc.insets = new Insets(10, 8, 6, 8);
        ...
        btnRegistrar.addActionListener(e -> {
            ...
            if (onRegister != null) onRegister.accept(new String[]{email, user, pass});
        });
